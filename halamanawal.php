...
<body>
  ...
  ?>
	<div class="kot1">
		Input Data Nilai Mahasiswa Matakuliah Kecerdasan Buatan
	</div>
	<div class="kot2">
		<div class="kot3">
		<form action="inputcoba.php" method="post">
			<table>
				<tr>
				<tr>
					<td>Nama </td>
	...
	<div class="kot4">
	<form action="inputcoba.php" method="post"><input type="submit" name="insert" value="Insert" style="float: right;margin-top: 20px; margin-right: 110px; background: teal; width: 100px; height: 30px;></form>
	</div>
