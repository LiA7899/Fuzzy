...
if(isset($_POST['insert'])){
  ...
  $result =  "INSERT INTO analisis_desain_algoritma (nama,nim,UTS,UAS,rerata,total_tugas,NA)VALUES('$nama','$nim','$UTS','$UAS',$rerata,'$total_tugas',$NA)";
